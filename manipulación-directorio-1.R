...
getwd()
setwd("/Users/jmgi2025/Documents/Sesiones-R-Taxi/")
########## Manipulación de Datos Locales ################
install.packages(c("tidyverse", "readxl", "ggplot2", "dplyr", "devtools"))
library(tidyverse)
library(readxl)
getwd()
...
install.packages(c("jsonlitte", "httr"))
library(jsonlite)
library(httr)
...
library(readxl)
# iso3166 IDs
iso3166 <- read_csv("RUTA-LOCAL")
iso3166
# Países 
paises <- read_csv("RUTA-LOCAL")
# Regiones
regiones <- read_csv("RUTA-LOCAL")
